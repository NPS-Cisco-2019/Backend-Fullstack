            ...
            <div className="App deskApp">
                ...
                <div className="body" style={{ top: this.state.headHeight }} id="main">
                    ...
                    <div className="description">
                        ...
                        <p style={{ fontSize: "1.3em", marginBottom: 30, textAlign: "center" }}>
                            SnapSearch is a problem solving app, just take a picture and the app
                            automatically scans the web to find the best answers for you.
                            <br />
                            TODO proper description
                        </p>
                        <h2>
                            Go to your mobile phone in one of the following browsers and follow
                            these tutorials to install it.
                        </h2>
                        <div className="logos">
                            <Link to="/Firefox">
                                    ...
                                    >
                                        <Switch location={location}>
                                            ...
                                            <Route
                                                path="/"
                                                render={() => {
                                                    return <Redirect to={this.defaultLink} />;
                                                }}
                                            />
